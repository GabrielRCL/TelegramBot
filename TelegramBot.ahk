...
#Include C:\MyAHKlibraries\Gdip.ahk
 
 ; ========= [TAKE SCREEN SHOT] =========
 ; test code that calls function
ScreenshotFile = %A_Temp%\ScreenShot.png ; most image formats work, such as bmp, gif, jpg, png, tif
TakeScreenshot(ScreenshotFile)


; ========= [TELEGRAM BOT SEND SCREEN SHOT] =========
IniRead, botToken, %A_ScriptDir%\TelegramBotConfigs.ini, TelegramBot, botToken
IniRead, chatID, %A_ScriptDir%\TelegramBotConfigs.ini, TelegramBot, chatID
SendPhoto(botToken, chatID, ScreenshotFile)
ExitApp

; Add your credentials here 
;botToken := "1832648016:AAGvtD_y9Em3KTHJgqTm4UkCqt3t4YJR7d8"
;chatID := 904152775
...
;msgbox % resp := SendPhoto(botToken, chatID, ScreenshotFile) 	; send the image; use msgbox for checking the json response
